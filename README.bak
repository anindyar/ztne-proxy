...
Zero Trust, No Exposure. Securely expose internal services to the internet in under 10 minutes using Cloudflare Tunnel and Nginx Proxy Manager.Built with 💙 by Vibe Coding, using the guidance from human intelligence and the genius of Artificial Intelligence (ChatGPT).
...
git clone https://github.com/vibecoding/ztne-proxy-setup.git
cd ztne-proxy-setup
